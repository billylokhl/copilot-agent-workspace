...
3. If no match is found and custom logic is mandatory, append a clear block comment at the top of the utility file
	detailing why a library was bypassed.
...
For MCP handlers, custom function hooks, or LLM-accessible tool schemas, see:

1. `.github/skills/map-tool-suitability-and-design/SKILL.md`
